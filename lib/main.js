...
require([
            ...
            function(data) {
                ...
                if (businesses && businesses.length > 0) {
                    businesses.forEach(function(business) {
                        addBusinessCard(business, business.location.coordinate);
                    });
    ...
    function addBusinessCard(business, coord) {
        $("#cards").append(
           ...
           '   <img class="activator cardIMG" src="' + business.image_url + '" onclick="cardOpen(' + coord + ')">' +
           '   <span class="card-title">' + business.name + '</span><div class="star-container">' + stars[Math.floor(business.rating)] + '</div>' +
           ' </div>' +
           ' <div class="card-reveal" style="display: none; transform: translateY(0px);">' +
           '   <span class="card-title grey-text text-darken-4">' + business.name + '<i class="material-icons right" onclick="cardClose()">close</i></span>' +
           '     <p>' + business.snippet_text + '</p>' +
           ' </div>' +
           '</div>');
    }

    function cardOpen(coord) {
