window.captial_one_recommends = { geojson: null, regions: null, debug: false };
$(function(){
    $.post(
        '/geojson',
        {
    ...
    function loadYelp(sw_latitude, sw_longitude, ne_latitude, ne_longitude) {
        $.post(
            ...
            function(data) {
                ...
                selectLayer.applyEdits([ new Graphic(new Point(coord.longitude, coord.latitude)) ], null, null);
            }
        );
    }
});