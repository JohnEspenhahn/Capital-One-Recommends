...
require([
        ...
        $.post(
            ...
            function(data) {
                ...
                if (businesses && businesses.length > 0) {
                    addBusinessCard(businesses[0], businesses[0].location.coordinate);
                    cardOpen(businesses[0].location.coordinate);
                }
            }
        );
    }
    ...
    var stars = [ 
        '', 
        '<i class="material-icons s">star_rate</i>', 
        '<i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i>', 
        '<i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i>', 
        '<i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i>', 
        '<i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i><i class="material-icons s">star_rate</i>' 
    ];
    function addBusinessCard(business, coord) {
        $("#cards").append(
           '<div class="card">' +
           ' <div id="cardIMG" class="card-image waves-effect waves-block waves-light">' +
           '   <img class="activator cardIMG" lat="' + coord.latitude + '" lng="' + coord.longitude + '" src="' + business.image_url + '">' +
           '   <span class="card-title">' + business.name + '</span><div class="star-container">' + stars[Math.floor(business.rating)] + '</div>' +
           ' </div>' +
           ' <div class="card-reveal" style="display: none; transform: translateY(0px);">' +
           '   <span id="cardClose" class="card-title grey-text text-darken-4">' + business.name + '<i class="material-icons right">close</i></span>' +
    ...
    $("#cardIMG").click(function() {
        cardOpen($(this).attr('lat'), $(this).attr('lng'));
    });

    $("#cardClose").click(cardClose);

    function cardOpen(lat, lng) {
        console.log('opening');
